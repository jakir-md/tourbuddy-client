    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-8 gap-4">
          ...
          <Link href="/explore" className="text-primary text-sm font-medium hover:underline flex items-center gap-1">
          ...
          {categories.map((category) => (
            ...
            >
              <Card className="h-full p-4 transition-all duration-300 hover:shadow-md border-slate-100 hover:border-slate-200 relative overflow-hidden">
                ...
                <div className={`absolute -right-4 -top-4 w-16 h-16 rounded-full opacity-0 group-hover:opacity-20 transition-all duration-500 ${category.bg}`} />

                <div className="relative z-10 flex flex-col items-start gap-3">
                  {/* Icon Wrapper: Smaller on mobile */}
                  <div className={`p-2 md:p-3 rounded-lg ${category.bg} transition-colors duration-300`}>
