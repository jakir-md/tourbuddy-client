...
//   switch (type) {
//     case 'food':
//       return { icon: Utensils, color: 'text-orange-500', bg: 'bg-orange-100', border: 'border-orange-200' }
//     case 'travel':
//       return { icon: Bus, color: 'text-blue-500', bg: 'bg-blue-100', border: 'border-blue-200' }
//     case 'stay':
//       return { icon: Bed, color: 'text-indigo-500', bg: 'bg-indigo-100', border: 'border-indigo-200' }
//     case 'visit':
//     default:
...
//               <Input
//                 placeholder="e.g., Weekend Getaway to Cox's Bazar"
//                 value={formData.name}
